package com.aguadaserra.app.util
...
class LocationService(private val context: Context) {
    ...
    // caso queira usar o time direto aqui
    ...
    var LOCATION_REFRESH_TIME = 5000L // 5 seconds to update
    var LOCATION_REFRESH_DISTANCE = 200F // 200 meters to update
